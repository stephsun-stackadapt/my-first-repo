CREATE OR REPLACE VIEW DM.BI.ACCOUNT_CAS_V_NEW(
	SF_ACCOUNT_ID,
	ACCOUNT_ID,
	CHILD_ID,
	CAS_CG,
...
CAS AS (
    ...
    FULL OUTER JOIN CAS_CAMPAIGN CAMP
       ...
       AND COALESCE(CG.ACCOUNT_ID, '__NULL__') = COALESCE(CAMP.ACCOUNT_ID, '__NULL__')
       AND COALESCE(CG.CHILD_ID, '__NULL__') = COALESCE(CAMP.CHILD_ID, '__NULL__')
)
