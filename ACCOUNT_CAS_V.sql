create or replace view DM.BI.ACCOUNT_CAS_V(
    SF_ACCOUNT_ID,
    CAS_CG,
    CAS_CAMPAIGN,
            ...
            CASE
                ...
                ELSE
                    CASE
                        ...
                        ELSE
                            GREATEST(0, (CG.CG_FLIGHT_BUDGET_USD - COALESCE(CG.CG_COST_USD, 0)) *
                                LEAST(DATEDIFF('DAY', CURRENT_DATE, CG.CG_END_DATE), DATEDIFF('DAY', CURRENT_DATE, CE.CAS_END_DATE_CURRENT)) /
            ...
            CASE
                ...
                ELSE
                    CASE
                        ...
                        ELSE
                            GREATEST(0, (CG.CG_FLIGHT_BUDGET_USD - COALESCE(CG.CG_COST_USD, 0)) *
                                LEAST(DATEDIFF('DAY', CURRENT_DATE, CG.CG_END_DATE), DATEDIFF('DAY', CURRENT_DATE, CE.CAS_END_DATE_NEXT)) /
                                DATEDIFF('DAY', CG.CG_START_DATE, CG.CG_END_DATE))
                    END
            END
            ...
            CASE
                ...
                ELSE
                    CASE
                        ...
                        ELSE
                            GREATEST(0, (CAMP.CAMPAIGN_FLIGHT_BUDGET_USD - COALESCE(CAMP.CURRENT_FLIGHT_CAMPAIGN_COST_USD, 0)) *
                                LEAST(DATEDIFF('DAY', CURRENT_DATE, CAMP.END_DATE), DATEDIFF('DAY', CURRENT_DATE, CE.CAS_END_DATE_CURRENT)) /
            ...
            CASE
                ...
                ELSE
                    CASE
                        ...
                        ELSE
                            GREATEST(0, (CAMP.CAMPAIGN_FLIGHT_BUDGET_USD - COALESCE(CAMP.CURRENT_FLIGHT_CAMPAIGN_COST_USD, 0)) *
                                LEAST(DATEDIFF('DAY', CURRENT_DATE, CAMP.END_DATE), DATEDIFF('DAY', CURRENT_DATE, CE.CAS_END_DATE_NEXT)) /
                                DATEDIFF('DAY', CAMP.START_DATE, CAMP.END_DATE))
                    END
            END
...
CAS AS (
    SELECT
        ...
        COALESCE(CG.CAS_CG, 0)
            + COALESCE(CAMP.CAS_CAMPAIGN, 0) AS TOTAL_COMMITTED_SPEND,
        ...
        COALESCE(CG.CAS_CG_THRU_NEXT_QTR, 0)
            + COALESCE(CAMP.CAS_CAMPAIGN_THRU_NEXT_QTR, 0) AS TOTAL_COMMITTED_SPEND_THRU_NEXT_QTR
